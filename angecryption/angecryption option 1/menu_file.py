...
def menu():
    ...
    parser.add_argument("-a", "--action",
                        choices=["encrypt", "decrypt", "decrypt-to-png", "decrypt-to-file", "hide-png-in-png",
                                 "hide-file-in-png", "make-png-clean", "make-file-clean"],
                        help="the action to perform:\n"
                             "encrypt: {}\n"
                             "decrypt: {}\n"
                             "decrypt-to-fileTYPE: {}\n"
                             "hide-fileTYPE1-in-filePNG: {}\n"
                             "combine-file-in-png: {}\n"
                             "make-png-clean: {}\n"
                             "make-file-clean: {}\n".format(
    ...
    if namespace.action in ["encrypt", "decrypt", "decrypt-to-png", "decrypt-to-file"]:
        if namespace.iv is None:
            parser.error('IV not specified')

    elif namespace.action in ["hide-png-in-png", "hide-file-in-png"]:
